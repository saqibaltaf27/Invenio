...
//router.get('/get_employees', isAuthenticated, (req, res) => user.getEmployees(req, res));


router.post('/get_employees', (req, res) => user.getEmployees(req, res));
...
router.post('/get_profile', (req, res) => user.getProfile(req, res));
