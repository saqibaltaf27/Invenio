...
function Dashboard() {
  ...
  useEffect(() => {
    if (productStats && Array.isArray(productStats) && productStats[0] && productStats[2]) {
                ...
                <div className="left">
                  ...
                  <div className="itme_stats">
                    <div style={{ flex: "1" }}>
                      ...
                      {
                        productStats && productStats[1] && Array.isArray(productStats[1]) &&
                    ...
                    </div>
                    {
                      ...
                      productGenderP[0] && productGenderP[1] && productGenderP[2] && (
                        <div className="d-flex justify-content-center align-items-center" style={{ flex: "1", position: "relative" }}>
                          <svg width="180px" height="180px" viewBox="0 0 42 42" className="donut">
                            <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954"
                              ...
                              strokeDasharray={`${productGenderP[1].percentage} ${100 - productGenderP[1].percentage}`}
                              strokeDashoffset="0" />
                            <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954"
                              fill="transparent" stroke="#f07fce" strokeWidth="5"
                              strokeDasharray={`${productGenderP[0].percentage} ${100 - productGenderP[0].percentage}`}
                              strokeDashoffset={-productGenderP[1].percentage} />
                            <circle className="donut-segment" cx="21" cy="21" r="15.91549430918954"
                              fill="transparent" stroke="#fcbc53" strokeWidth="5"
                              strokeDasharray={`${productGenderP[2].percentage} ${100 - productGenderP[2].percentage}`}
                              strokeDashoffset={-(productGenderP[1].percentage + productGenderP[0].percentage)} />
                          </svg>
                ...
                <div className="right">
                  ...
                  <div style={{ overflowX: "auto" }}>
                    <div className="d-flex gap-1">
                      {
                        productStats && productStats[3] && Array.isArray(productStats[3]) &&
